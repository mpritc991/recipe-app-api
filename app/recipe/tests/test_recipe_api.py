...
# reverse function to get the URL for the recipe list
#  endpoints used in multiple test cases
...
class PrivateRecipeApiTests(TestCase):
    ...
    def test_create_recipe(self):
        ...
        # this is what VSC automatically generated "K, V" is short for "key, value"
    ...
    def test_full_update_recipe(self):
        ...
        recipe.refresh_from_db()
        # the below code allows you to check every field in the payload automatically, instead of writing:
        # self.assertEqual(recipe.title, payload["title"])
    ...
    def test_create_recipe_with_new_tags(self):
        ...
        # format='json' is needed to send complex data structures like lists and dictionaries
    ...
    def test_create_recipe_with_existing_tag(self):
        ...
        tag_food = Tag.objects.create(user=self.user, name='Indian')
        payload = {
            'title': 'Pongal',
            'time_minutes': 5,
            'price': Decimal('4.50'),
        ...
        recipe = recipes[0]
        self.assertEqual(recipe.tags.count(), 2)
        self.assertIn(tag_food, recipe.tags.all())
        for tag in payload['tags']:
            exists = recipe.tags.filter(
                name=tag['name'],
                user=self.user,
